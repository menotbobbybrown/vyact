...
export default function McpPromptField({value, defaultValue, onChange, separated = false}: {
    value: string;
    defaultValue: string;
    ...
    return <div className={`mcp-field${separated ? ' mcp-prompt-section' : ''}`}>
        <div className="mcp-prompt-heading">
            ...
            <button type="button" className="mcp-icon-btn" disabled={value === defaultValue}
