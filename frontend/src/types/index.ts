...
export interface ProjectMemoryItem { id: string; text: string; status: 'active' | 'completed' | 'superseded'; supersedes?: string; superseded_by?: string; owner?: string; due_date?: string; source_conv_id?: string; created_at: string; updated_at: string; }
